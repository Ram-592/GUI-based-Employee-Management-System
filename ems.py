...
logo = CTkImage(Image.open('bg.jpg'),size=(1000,158))
...
role_options=['Web Developer','Cloud Architect','Technical Writer','Network Engineer',
              'Devops Engineer','Data Scientist','Buisness Analyst','IT Consultant','UX/UI Designer']
...
rightFrame.grid(row=1,column=1,pady=20,padx=10)
